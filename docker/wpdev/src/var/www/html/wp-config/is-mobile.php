	...
	*/
	...
	static function is_facebook_for_iphone() {
		...
		if ( strpos( $ua, 'iphone' ) === false ) {
			return false;
		} elseif ( strpos( $ua, 'facebook' ) !== false && strpos( $ua, 'ipad' ) === false ) {
			return true;
		} elseif ( strpos( $ua, 'fbforiphone' ) !== false && strpos( $ua, 'tablet' ) === false ) {
			return true;
		} elseif ( strpos( $ua, 'fban/fbios;' ) !== false && strpos( $ua, 'tablet' ) === false ) { //FB app v5.0 or higher
			return true;
		} else {
			return false;
		}
